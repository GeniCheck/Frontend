...
import EvaluationResultPage from "@/pages/verification/EvaluationResultPage";
    ...
    <RoleProvider>
      <Router>
        <Routes>
          ...
          <Route path="/hr/accept-invite" element={<HrAcceptInvitePage />} />
          ...
          {/* 직원용 검증 결과 확인 페이지: 대표 검증 완료 통보 시 발송되는
              링크, 로그인 불필요 */}
          <Route
            path="/evaluation/result/:token"
