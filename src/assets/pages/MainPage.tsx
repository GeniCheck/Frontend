...
const MainPage: React.FC = () => {
  ...
  const location = useLocation(); // ★ 현재 주소창의 실시간 경로를 읽어옵니다.
  ...
  return (
    <div className="min-h-screen flex bg-[#F3F4F6] text-[#1A1A2E] font-sans antialiased overflow-x-hidden selection:bg-[#5B50E8]/20">
      {/* ─── 1. LEFT SIDEBAR (화면 고정형 사이드 메뉴 바) ─── */}
        ...
        <div>
          ...
          <div className="space-y-6">
              ...
              <nav className="space-y-1">
                {[
                  ...
                  },
                  {
                    name: "Referral",
                    icon: "ti-users",
                    path: "/referral", // ★ /referral 경로 완벽 연동
                    badge: null,
                  },
                  {
                    name: "AI Reports",
                  ...
                  // ★ 임시 탭 상태 대신 현재 주소창 주소와 일치하는 메뉴를 찾아서 불을 켭니다!
                  const isActive = location.pathname === item.path;
                  return (
                    <button
                      key={item.name}
                      onClick={() => {
                        if (item.path !== "#") navigate(item.path); // 클릭하면 즉시 주소 이동
                      }}
            ...
            <div>
              ...
              <nav className="space-y-1">
                {[
                  { name: "Support", icon: "ti-help-circle", path: "/support" },
                  { name: "Credits", icon: "ti-coin", path: "/credits" },
                ].map((item) => {
                  const isActive = location.pathname === item.path;
                  return (
                    <button
      ...
      {/* ─── 2. RIGHT CONTENT AREA (우측 데이터 연동 대시보드 뷰) ─── */}
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-[22px] p-6 shadow-sm text-left">
                ...
                <div className="mt-4 flex justify-end gap-4 text-[10px] font-bold">
                  ...
                  <div className="flex items-center gap-1.5 text-[#5B50E8]">
              ...
              <div className="bg-white border border-gray-200 rounded-[22px] p-5 shadow-sm text-left">
                ...
                <div className="mt-4 space-y-1.5">
                  <div className="flex justify-between text-[10px] font-bold">
                    ...
                    <span className="text-[#5B50E8] font-black">
                      112 / 150건
                    </span>
                  </div>
